  ...
  const values = [
    {
      ...
      title: "Mission",
      description:
        "To empower businesses with cutting-edge digital solutions that drive growth and innovation in the global marketplace.",
    ...
    },
    {
      ...
      title: "Vision",
      description:
        "To be the leading provider of future-ready digital solutions, transforming how businesses operate and interact with their customers.",
    ...
    },
    {
      ...
      title: "Values",
      description:
        "Innovation, Quality, Transparency, and Customer Success are at the core of everything we do. We believe in building lasting partnerships.",
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <h2
            id="about-heading"
            className="text-3xl md:text-5xl font-bold font-sora mb-2 flex items-center justify-center gap-3"
          >
            <span className="text-6xl md:text-7xl lg:text-8xl font-extrabold font-sora mb-8 leading-tight animate-fade-in bg-gradient-to-r from-blue-500 via-purple-500 to-gray-700 text-transparent bg-clip-text">About</span>
            <img
              src="/logo.png"
              alt="Vyoom Tech Logo"
              className="inline-block h-28 md:h-32 mt-2 object-contain"
            />
          </h2>
          ...
          <GradientText>
            <p className="leading-relaxed">
              <GradientText>
                ...
                difference. Our team combines creativity, technical expertise,
