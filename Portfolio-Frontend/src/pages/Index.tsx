...
const Index = () => {
  useEffect(() => {
    ...
    document.title = "Vyoom Tech - Building Future-Ready Digital Solutions | Mobile Apps & Web Development";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Vyoom Tech specializes in Android app development, Flutter development, website creation, and AI/ML solutions. Transform your business with our cutting-edge digital services.');
    }
